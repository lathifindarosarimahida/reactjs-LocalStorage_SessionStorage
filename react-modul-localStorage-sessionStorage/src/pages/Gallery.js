...
class Gallery extends React.Component{
    ...
    // setUser = () =>{
    //     //cek esistensi dari session storage
    ...
    //             //simpan nama userke session storage
    ...
    //         }
    //     }else {
    //         //kondisi saat session storage dengan key "user" telah dibuat
    ...
    setUser = () =>{
        //cek esistensi dari local storage
        if(localStorage.getItem("user") === null){
            ...
            if(prompt === null || prompt === ""){
                ...
                //simpan nama userke local storage
            ...
            //kondisi saat local storage dengan key "user" telah dibuat
    ...
    addToCart = (selectedItem) => {
        //membuat variabel untuk menampung cart sementara
        let tempCart = []
        ...
        if(existItem){
            ...
            let promptJumlah = window.prompt("Masukkan jumlah beli","")
            if(promptJumlah !== null && promptJumlah !== ""){
                //jika user memasukkan jumlah item yang dibeli

                //menambhakan properti "jumlahBeli" pada item yang dipilih
    ...
    //fungsi bawaan struktur react
    componentDidMount(){ //artinya komponen telah terpasang
